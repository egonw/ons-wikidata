...
SELECT ?wd ?ror ?openalex WHERE {
  SERVICE <https://query.wikidata.org/sparql> {
    SELECT (substr(str(?wikidata),32) as ?wd) ?ror ?openalex WHERE {
      ${rorValues}
      ?wikidata wdt:${rorProp} ?ror .
