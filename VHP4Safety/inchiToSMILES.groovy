...
// @Grab(group='io.github.egonw.bacting', module='managers-pubchem', version='1.0.0')
// @Grab(group='io.github.egonw.bacting', module='managers-inchi', version='1.0.0')
...
@Grab(group='io.github.egonw.bacting', module='managers-pubchem', version='0.3.2')
@Grab(group='io.github.egonw.bacting', module='managers-inchi', version='0.3.2')
...
inchiFile = "/VHP4Safety/aop_stressors.tsv"
idIndex = null
inchikeyIndex = 0
...
new File(bioclipse.fullPath(inchiFile)).eachLine { line ->
  ...
  if (map.contains(inchikey)) {
    println "# $inchikey is already in VHP4Safety Compounds"
    return
  }
